...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            defcalgrammar "openpulse";
            cal {
                waveform wf1 = drag(2, 100ns, 20ns, 0.05);
            }
            """,
            r"Invalid amplitude initialization 'IntegerLiteral' in 'drag'",
            r"Error at line 2, column 31",
        ),
        (
            """
        ...
        (
            ...
            defcalgrammar "openpulse";
            cal {
                waveform wf1 = sine(1.0 + 2.0im, 100ns, 5, 0.0);
            }
            """,
        ...
        (
            ...
            cal {
               int wf1;
               waveform wf2 = phase_shift(gaussian(1.0 + 2.0im, 100ns, 5.0ns),2.0);
